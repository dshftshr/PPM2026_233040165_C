        ...
        child: Column(
          ...
          children: [
              ...
              child: Column(
                children: [
                  const CircleAvatar(
                    ...
                    child: Icon(Icons.emoji_emotions_outlined, size: 60, color: Colors.black),
                  ),
            ...
            const _SectionCard(
              ...
              title: 'Tentang Saya',
              content: 'Mahasiswa Teknik Informatika UNPAS semester 6.',
            ),
            const _SectionCard(
              icon: Icons.school,
              title: 'Pendidikan',
            ...
            const _SectionCard(
              icon: Icons.favorite,
              title: 'Hobi & Minat',
              content: 'Menghitung Uang',
            ),
            const _SectionCard(
              icon: Icons.email,
              title: 'Kontak',
              content: 'desihafitaashri.dha@gmail.com\n+62-83862078854',
            ),
            // Section Skills
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Row(
                      children: [
                        Icon(Icons.star, color: Colors.teal, size: 28),
                        SizedBox(width: 16),
                        Text('Skills',
                            style: TextStyle(
